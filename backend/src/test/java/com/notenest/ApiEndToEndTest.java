...
// Test tingkat aplikasi: seluruh context di-start sungguhan, lalu API-nya
// dipanggil lewat HTTP. Logika bisnisnya sendiri sudah punya unit test di
// paket masing-masing; yang dibuktikan di sini adalah hal-hal yang hanya
// muncul saat semuanya dirakit - rantai security, terjemahan token jadi
// header identitas, dan sisi note yang menemukan user tanpa jaringan.
@SpringBootTest
...
class ApiEndToEndTest {
    ...
    // Jalur yang di branch dev memakai Feign lewat Eureka. Di sini UserClient
    // dipenuhi LocalUserClient; hasil yang dilihat client harus tetap sama.
    @Test
    void shareResolvesTargetUserLocally() throws Exception {
    ...
    // Email yang tidak terdaftar: UserClient menjawab Optional kosong dan
    // NoteServiceImpl menerjemahkannya. Client harus melihat 404, bukan 500.
    @Test
