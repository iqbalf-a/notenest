package com.notenest.monolith.exception;

import com.notenest.authservice.exception.EmailAlreadyExistsException;
import com.notenest.monolith.dto.ApiResponse;
...
//
// Handler FeignException milik note-service tidak ikut: tidak ada panggilan HTTP
// antar-service lagi, jadi 502 "gagal menghubungi user-service" mustahil terjadi.
...
public class GlobalExceptionHandler {
    ...
    // Email tujuan share tidak terdaftar. Di build gabungan exception ini
    // dilempar UserClient lokal, bukan hasil terjemahan 404 dari Feign.
